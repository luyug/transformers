...
#SBATCH -o /bos/tmp16/luyug/outputs/multibert/logs/score-10-anchor.out
#SBATCH --gres=gpu:4 # Use 1 GPUs
#SBATCH -p gpu
test_pair_dir=/bos/tmp16/luyug/data/marco/test_pair/6980-no-filter
output_dir=/bos/tmp16/luyug/outputs/multibert/models/10-anchor
ranking_dir=/bos/tmp16/luyug/outputs/multibert/rankings/10-anchor
